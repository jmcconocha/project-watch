...
export function ProjectDetail() {
  ...
  // In a real app, these would be fetched from a backend or state management
  const [project, setProject] = useState({ ...sampleProject, id: id || sampleProject.id })
